...
Error.flm <- function(G1.train, G2.train, Y.train, G1.test, G2.test, Y.test, pos1, pos2, ratio = 0.1, ratio2 = 0.1, valid = T){
...
## FNN wide
Error.FNNwide <- function(parameters, G.wide, Y, index, Bases.wide, activation, nhidden,
  ...
  Y.hat <- pred.wide(parameters, G.wide, Bases0 = Bases0, activation, nhidden = nhidden,
